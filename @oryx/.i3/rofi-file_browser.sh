...
ROFI_FB_PREV_LOC_FILE=~/.cache/rofi/fb_script_prevloc
ROFI_FB_HISTORY_FILE=~/.cache/rofi/fb_script_history 
ROFI_FB_HISTORY_MAXCOUNT=14 # maximum number of history entries
